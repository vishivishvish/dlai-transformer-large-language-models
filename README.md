...
***Notes by Vishnu Subramanian - Associate Manager, Accenture | AI Researcher & Instructor, BloomTech***
...
- The Decoder on the other hand, is used for Text Generation tasks, such as Text Summarization, Code Writing and Question Answering. It is the basis for most of today’s popular LLMs from orgs like OpenAI, Google, Anthropic, xAI, Meta, Mistral & Cohere.
